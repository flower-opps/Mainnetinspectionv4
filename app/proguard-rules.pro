...
-keepclassmembers class * {
    @com.jizhenkeji.mainnetinspection.controller.remotehardwarecontroller.HardwareStateListener *;
    @com.jizhenkeji.mainnetinspection.mission.followwire.SubscribeEvent *;
}
